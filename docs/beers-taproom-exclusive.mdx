...
<Tabs>
  <TabItem value="1" label="1" default>
    ...
    |:----------------------------|:--------------------------------------|:---------------------------------------------|
    | 5.7%                        | ???                                    | ![Baba Oatmeal Smoke Porter - ??? SRM](beer-color-SRM-40.svg) |
  ...
  <TabItem value="2" label="2">
    ...
    | Alcohol by volume (ABV) | International bitterness units (IBUs) | Color (SRM)                                  |
    |:----------------------------|:--------------------------------------|:---------------------------------------------|
    | 5.7%                        | 25                                    | ![Bashamichi Ale - ??? SRM](beer-color-SRM-19.svg) |
  ...
  <TabItem value="3" label="3">
    ...
    | Alcohol by volume (ABV) | International bitterness units (IBUs) | Color (SRM)                                  |
    |:----------------------------|:--------------------------------------|:---------------------------------------------|
    | 6.1%                        | ??                                    | ![Harajuku Ale - ??? SRM](beer-color-SRM-8.svg) |
  ...
  <TabItem value="4" label="4">
    ...
    | Alcohol by volume (ABV) | International bitterness units (IBUs) | Color (SRM)                                  |
    |:----------------------------|:--------------------------------------|:---------------------------------------------|
    | 4.5%                        | ???                                    | ![Nakameguro Bitter - ??? SRM](beer-color-SRM-14.svg) |
